...
EMSCRIPTEN_BINDINGS(libLCE) {
    ...
    emscripten::enum_<lce::io::ByteOrder>("ByteOrder")
    ...
    emscripten::class_<lce::save::SaveFile,
        ...
        .constructor<lce::io::ByteOrder, uint16_t, uint16_t>()
    ...
    emscripten::class_<lce::world::Region>("Region")
        ...
        .property("dim", &lce::world::Region::getDim,
                  &lce::world::Region::setDim)
        .class_function("getXZFromFilename",
                        &lce::world::Region::getXZFromFilename)
        .class_function("getDimFromFilename",
                        &lce::world::Region::getDimFromFilename);

    emscripten::class_<lce::world::SplitSave,
                       emscripten::base<lce::world::Region>>("SplitSave")
        .class_function("getXZFromFilename",
                        &lce::world::SplitSave::getXZFromFilename)
        .class_function("getDimFromFilename",
                        &lce::world::SplitSave::getDimFromFilename);
