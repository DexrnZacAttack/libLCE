...
namespace lce::io {
    ...
    std::u16string BinaryIO::readWChar2ByteNT(const io::ByteOrder endian) {
    ...
    std::u32string BinaryIO::readWChar4ByteNT(const io::ByteOrder endian) {
